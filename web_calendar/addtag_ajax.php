...
if(isset($_POST['tag'])&&isset($_POST['id'])){
}
else{
echo json_encode(array("success" => false,"message" => "please fill in required areas"));
	exit;
}
...
echo json_encode(array("success" => false,"message" => "there is no such an event to tag! "));
exit;
}
